...
public class PrimeClient_2_3_B {
    private static final String HOSTNAME = "localhost";
    private static final int PORT = 1234;
    private static final long INITIAL_VALUE = (long) 1e17;
    private static final long COUNT = 5;
    private static final String CLIENT_NAME = PrimeClient_2_3_B.class.getName();
    ...
    public PrimeClient_2_3_B(String hostname, int requestPort, int answerPort, long initialValue, long count) {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        while (!doExit) {
            ...
            new PrimeClient_2_3_B(hostname, requestPort, answerport, initialValue, count).run();
